...
namespace Brakt.Rest.Database
{
    ...
    public interface ICommandExecutor
    {
        ...
        /// <returns><see cref="IEnumerable{T}"/></returns>
        IEnumerable<T> Execute<T>(ICommand command, Func<IDataReader, T> rowMapper);
        /// <summary>
        /// Executes a command and returns the first row as an instance of <typeparamref name="T"/>
        /// </summary>
        /// <typeparam name="T">the type to convert the query result.</typeparam>
        ...
        /// <param name="rowMapper">A function to map <typeparamref name="T"/> from <see cref="IDataReader"/></param>
        /// <returns>an instance of <typeparamref name="T"/></returns>
        T ExecuteSingle<T>(ICommand command, Func<IDataReader, T> rowMapper);
        /// <summary>
        ...
        /// <param name="cancellationToken">token used to cancel the action</param>
        /// <returns><see cref="IEnumerable{T}"/></returns>
        Task<IEnumerable<T>> ExecuteAsync<T>(ICommand command, Func<IDataReader, T> rowMapper, CancellationToken cancellationToken);
        /// <summary>
        /// Executes a command asynchronously and returns the first row as an instance of <typeparamref name="T"/>
        /// </summary>
        /// <typeparam name="T">the type to convert the query result.</typeparam>
        ...
        /// <param name="cancellationToken">token used to cancel the action</param>
        /// <returns>an instance of <typeparamref name="T"/></returns>
        Task<T> ExecuteSingleAsync<T>(ICommand command, Func<IDataReader, T> rowMapper, CancellationToken cancellationToken);
        /// <summary>
        ...
        /// <param name="rowMapper">A function to map <typeparamref name="T"/> from <see cref="IDataReader"/></param>
        /// <returns><see cref="IEnumerable{T}"/></returns>
        Task<IEnumerable<T>> ExecuteAsync<T>(ICommand command, Func<IDataReader, T> rowMapper);
        /// <summary>
        /// Executes a command asynchronously and returns the first row as an instance of <typeparamref name="T"/>
        /// </summary>
        /// <typeparam name="T">the type to convert the query result.</typeparam>
        ...
        /// <param name="rowMapper">A function to map <typeparamref name="T"/> from <see cref="IDataReader"/></param>
        /// <returns>an instance of <typeparamref name="T"/></returns>
        Task<T> ExecuteSingleAsync<T>(ICommand command, Func<IDataReader, T> rowMapper);
        /// <summary>
        /// Executes a command asynchronously and returns the first column of the first row as an instance of <typeparamref name="T"/>
        /// </summary>
        /// <typeparam name="T">the type to convert the query result.</typeparam>
